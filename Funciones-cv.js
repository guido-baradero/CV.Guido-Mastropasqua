let Krause ="📐Escuela Técnica Nº1 OTTO KRAUSE / Egreso 2004|Técnico electrónico con orientación en telecomunicaciones.";             
let listaKrause = ["ingles", "Office", "Base de datos", "Programación","Talleres"];
let htmlKrause = `<ul>`;
let k = 0;

let inti = "🔬Energía atómica / Año 2005";
let listaInti = ["conceptos generales: Átomo, partícula", "Almacenamiento", "Fision y Fusion", "Aplicaciones"];
let htmlInti = `<ul>`;
let i = 0;

let CETAE = "📈Ventas y Marketing / Año 2007";
let listaCETAE = ["El cliente", "Bases de Marketin", "Negociación", "Estrategias de venta"];
let htmlCETAE = `<ul>`;
let c = 0;

let Ticmas = "💻Diseño y pregramación de páginas web con las herramientas HTML, CSS y JavaScript / Actualmente";
let listaTicmas = ["Desarrollo de paginas Web", "Capa de presentacion CSS", "Fundamentos de la programación", "Fundamentos de JavaScript I"];
let htmlTicmas = `<ul>`;
let t = 0
...
document.getElementById("Krause").onmouseover = function() {
    ...
    document.getElementById("info-Krause").innerHTML = "Técnico electrónico con orientación en telecomunicaciones"
}
...
document.getElementById("INTI").onmouseover = function() {
    ...
    document.getElementById("info-INTI").innerHTML = "Instituto Nacional de Tecnología Industrial"
}
...
document.getElementById("Ticmas").onmouseover = function() {
    ...
    document.getElementById("info-Ticmas").innerHTML = "Programación Front-End"
}
